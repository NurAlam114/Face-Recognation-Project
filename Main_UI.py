...
class Face_Recognation_System:
    ...
    def __init__(self, root):
        ...
        def open_Face_Recognization():
            self.root.destroy()
            subprocess.Popen(["python", "Face_Detector.py"])
        ...
        def open_Help_Desk():
            self.root.destroy()
            subprocess.Popen(["python", "Help_Desk.py"])
    ...
    def open_img(self):
        os.startfile('sample_image_data')
