...
class Student_Details:
    def __init__(self, root):
        ...
        if os.path.exists(temp_path):
            try:
                ...
                self.var_batch.set(str(student.get("batch", "")))
        ...
        # ---------- Batch ----------
        batch_label = Label(Current_Course_frame, text="Select Batch:", font=("Times New Roman", 12, "bold"), bg="light gray")
        batch_label.grid(row=1, column=2, padx=20, pady=10, sticky=W)

        batch_combo = ttk.Combobox(Current_Course_frame, textvariable=self.var_batch, font=("Times New Roman", 12), state="readonly", width=20)
        batch_combo["values"] = ("28", "29", "30", "31", "32")
        batch_combo.grid(row=1, column=3, padx=20, pady=10, sticky=W)
    ...
    def add_data(self):
        ...
        if self.var_batch.get() == "":
            messagebox.showerror("Error", "batch is required", parent=self.root); return False
        ...
        try:
            ...
            messagebox.showerror("Error", "Student ID, batch and Phone must be numbers", parent=self.root)
            return False
        ...
        try:
            ...
            cursor.execute(
                ...
                INSERT INTO face_recognizer (
                    Student_ID, Student_Name, Department, Course, Batch, Semester,
                ...
                (
                    ...
                    batch, self.var_semester.get(), self.var_sec.get(), self.var_gender.get(),
    ...
    def update_data(self):
        ...
        batch_val  = to_int_or_none(self.var_batch.get())
        ...
        try:
            ...
            cursor.execute(
                ...
                (
                    ...
                    batch_val, self.var_semester.get(), self.var_sec.get(), self.var_gender.get(),
                    self.var_blood.get(), self.var_nationality.get(), self.var_email.get(),
            ...
            try:
                while True:
                    ...
                    if face is not None and time.time() >= pose_ready_at:
                        ...
                        time.sleep(0.5)  # delay for smoother capture
